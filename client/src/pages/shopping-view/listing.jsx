...
function ShoppingListing() {
  ...
  function handleFilter(getSectionId, getCurrentOption) {
    if (getSectionId === "brand") return; // ✅ Ignore brand filter

    let updatedFilters = { ...filters };
    const sectionOptions = updatedFilters[getSectionId] || [];

    if (sectionOptions.includes(getCurrentOption)) {
      updatedFilters[getSectionId] = sectionOptions.filter((opt) => opt !== getCurrentOption);
    } else {
      updatedFilters[getSectionId] = [...sectionOptions, getCurrentOption];
    }
